...
import tooltwist.bada.productionHelpers.ShowClientWidgetProductionHelper;
 ...
 * Show Client
 */
public class ShowClientWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "showClientWidget_preview.html";
	private static final String SNIPPET_DESIGN = "showClientWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "showClientWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "showClientWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "showClientWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "showClientWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				// Include a javascript snippet 
				new JavascriptCodeInserter(generator, instance, "showClientWidget_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ShowClientWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ShowClientWidgetProductionHelper.class.getName()));
			}
		}
