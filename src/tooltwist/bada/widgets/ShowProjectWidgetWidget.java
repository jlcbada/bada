...
import tooltwist.bada.productionHelpers.ShowProjectWidgetProductionHelper;
 ...
 * Show Project Widget
 */
public class ShowProjectWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "showProjectWidget_preview.html";
	private static final String SNIPPET_DESIGN = "showProjectWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "showProjectWidget_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator,instance, "showProjectWidget_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator,instance, "showProjectWidget_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ShowProjectWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ShowProjectWidgetProductionHelper.class.getName()));
			}
		}
