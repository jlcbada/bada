...
import tooltwist.bada.productionHelpers.PositionWidgetProductionHelper;
 ...
 * Position Widget
 */
public class PositionWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "positionWidget_preview.html";
	private static final String SNIPPET_DESIGN = "positionWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "positionWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "positionWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "positionWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "positionWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, PositionWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(PositionWidgetProductionHelper.class.getName()));
			}
		}
