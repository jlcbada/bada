...
//import tooltwist.bada.productionHelpers.HeaderWidgetProductionHelper;
 ...
 * Header Widget
 */
public class HeaderWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "headerWidget_preview.html";
	private static final String SNIPPET_DESIGN = "headerWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "headerWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "headerWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "headerWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "headerWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HeaderWidgetProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(HeaderWidgetProductionHelper.class.getName()));
			}
		}
