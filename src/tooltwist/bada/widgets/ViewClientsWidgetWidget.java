...
import tooltwist.bada.productionHelpers.ViewClientsWidgetProductionHelper;
 ...
 * View Client
 */
public class ViewClientsWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "viewClientsWidget_preview.html";
	private static final String SNIPPET_DESIGN = "viewClientsWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "viewClientsWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "viewClientsWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "viewClientsWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "viewClientsWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ViewClientsWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ViewClientsWidgetProductionHelper.class.getName()));
			}
		}
