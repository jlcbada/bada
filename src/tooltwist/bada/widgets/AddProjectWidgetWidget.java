...
import tooltwist.bada.productionHelpers.AddProjectWidgetProductionHelper;
 ...
 * Add Project Widget
 */
public class AddProjectWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "addProjectWidget_preview.html";
	private static final String SNIPPET_DESIGN = "addProjectWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "addProjectWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "addProjectWidget_cssHeader.css")),
			};
...
//				// Include a javascript snippet 
				new JavascriptCodeInserter(generator, instance, "addProjectWidget_jsHeader.js"),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "addProjectWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AddProjectWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(AddProjectWidgetProductionHelper.class.getName()));
			}
		}
