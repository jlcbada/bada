...
import tooltwist.bada.productionHelpers.AssignmentTabWidgetProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * Assignment Tab Widget
 */
public class AssignmentTabWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "assignmentTabWidget_preview.html";
	private static final String SNIPPET_DESIGN = "assignmentTabWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "assignmentTabWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "assignmentTabWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "assignmentTabWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance,  "assignmentTabWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AssignmentTabWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(AssignmentTabWidgetProductionHelper.class.getName()));
			}
		}
...
//		String myProperty = instance.getProperty("myProperty", null);
		...
		if (myCurrentNavpoint == null) myCurrentNavpoint = "";
		SnippetParam[] params = {
//			new SnippetParam("myProperty", myProperty),
		new SnippetParam("myCurrentNavpoint", myCurrentNavpoint),
