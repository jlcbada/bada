...
import tooltwist.bada.productionHelpers.MyNewVerticalMenuWidgetProductionHelper;
import com.dinaa.ui.UimData;
import com.dinaa.ui.UimHelper;

/**
 * New Vertical Menu Widget
 */
public class MyNewVerticalMenuWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "myNewVerticalMenuWidget_preview.html";
	private static final String SNIPPET_DESIGN = "myNewVerticalMenuWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "myNewVerticalMenuWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "myNewVerticalMenuWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "myNewVerticalMenuWidget_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "myNewVerticalMenuWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, MyNewVerticalMenuWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(MyNewVerticalMenuWidgetProductionHelper.class.getName()));
			}
		}
	...
	{
		return "New Vertial Menu Widget";
	}
...
//		String myProperty = instance.getProperty("myProperty", null);
		...
		String myCurrentNavpoint = WbdSession.getNavpointId(ud.getCredentials());
		if (myCurrentNavpoint == null) 
			{myCurrentNavpoint = "";}
		SnippetParam[] params = {
//			new SnippetParam("myProperty", myProperty),
		new SnippetParam("myCurrentNavp", myCurrentNavpoint),
		new SnippetParam("myNavp", myNavpoint)
