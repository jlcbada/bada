...
//import tooltwist.bada.productionHelpers.LinkWidgetProductionHelper;
 ...
 * Link Widget
 */
public class LinkWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "linkWidget_preview.html";
	private static final String SNIPPET_DESIGN = "linkWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "linkWidget_production.jsp";
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdNavPointProperty("target", null, "Target Link", ""));
	}
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "linkWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "linkWidget_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, LinkWidgetProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(LinkWidgetProductionHelper.class.getName()));
			}
		}
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		...
		SnippetParam[] params = {
			new SnippetParam("linkLabel", label),
			new SnippetParam("linkTarget", target)
		};
		return params;
	}
}
