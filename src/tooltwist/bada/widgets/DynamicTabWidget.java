...
import tooltwist.bada.productionHelpers.DynamicTabProductionHelper;
 ...
 * Dynamic Tab Widget
 */
public class DynamicTabWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "dynamicTab_preview.html";
	private static final String SNIPPET_DESIGN = "dynamicTab_design.html";
	private static final String SNIPPET_PRODUCTION = "dynamicTab_production.jsp";
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "dynamicTab_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "dynamicTab_jsHeader.js"),
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, DynamicTabProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(DynamicTabProductionHelper.class.getName()));
			}
		}
...
//		String myProperty = instance.getProperty("myProperty", null);
		...
		if (currentNavpoint==null) currentNavpoint="";
		SnippetParam[] params = {
//			new SnippetParam("myProperty", myProperty),
				new SnippetParam("myCurrentNavpoint", currentNavpoint),
