...
import tooltwist.bada.productionHelpers.AccountWidgetProductionHelper;
 ...
 * Account Widget
 */
public class AccountWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "accountWidget_preview.html";
	private static final String SNIPPET_DESIGN = "accountWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "accountWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "accountWidget_cssHeader.css")),
			};
...
//				// Include a javascript snippet 
				new JavascriptCodeInserter(generator, instance, "accountWidget_jsHeader.js"),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "accountWidget_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, AccountWidgetProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(AccountWidgetProductionHelper.class.getName()));
			}
		}
