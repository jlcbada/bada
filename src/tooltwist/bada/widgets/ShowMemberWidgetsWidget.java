...
import tooltwist.bada.productionHelpers.ShowMemberWidgetsProductionHelper;
 ...
 * Show Member Widgets
 */
public class ShowMemberWidgetsWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "showMemberWidgets_preview.html";
	private static final String SNIPPET_DESIGN = "showMemberWidgets_design.html";
	private static final String SNIPPET_PRODUCTION = "showMemberWidgets_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "showMemberWidgets_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "showMemberWidgets_jsHeader.js")),

				// Include a CSS snippet
				new StylesheetCodeInserter(generator, instance, "showMemberWidgets_cssHeader.css"),
			};
			codeInserterList.add(arr);
		}
...
//				new PageImportCodeInserter(XData.class.getName()),
			...
			if (USE_PRODUCTION_HELPER)
			{
				...
				codeInserterList.add(WbdProductionHelper.codeInserter(instance, ShowMemberWidgetsProductionHelper.class.getName(), productionHelperParams));
				codeInserterList.add(new PageImportCodeInserter(ShowMemberWidgetsProductionHelper.class.getName()));
			}
		}
