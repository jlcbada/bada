...
//import tooltwist.bada.productionHelpers.HrSeparatorWidgetProductionHelper;
 ...
 * hr Separator
 */
public class HrSeparatorWidgetWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "hrSeparatorWidget_preview.html";
	private static final String SNIPPET_DESIGN = "hrSeparatorWidget_design.html";
	private static final String SNIPPET_PRODUCTION = "hrSeparatorWidget_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "hrSeparatorWidget_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "hrSeparatorWidget_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, HrSeparatorWidgetProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(HrSeparatorWidgetProductionHelper.class.getName()));
			}
		}
